...
def get_user_analytics(
    ...
    avg_connections = db.query(
        func.avg(func.count(Connection.id))
    ).select_from(Connection).group_by(Connection.user_id).scalar() or 0
    ...
    return {
        ...
        "average_connections_per_user": round(float(avg_connections), 2)
    }
...
def get_connection_analytics(
    ...
    # Platform distribution of connections
